...
import { Check, X, FileSpreadsheet, PenLine, History, Inbox, CheckCheck, Pencil, Search, ChevronLeft, ChevronRight } from "lucide-react";
...
export function VerifyPublish({ onNavigate }: { onNavigate: (id: ScreenId) => void }) {
  ...
  const changeTab = (t: "pending" | "audit") => { setTab(t); setPage(1); };
